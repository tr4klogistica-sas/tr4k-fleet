...
import { Dashboard, HojaVida, Mantenimiento, KmDiarios, Costos, Alertas } from './pages/Pages.jsx'
...
export default function App() {
  ...
  function renderView() {
    switch (view) {
      ...
      case 'hojavida': return <HojaVida vehicle={selectedVehicle} maintenances={allMaintenances[selectedId] || []} costs={allCosts[selectedId] || []} onSaved={reloadVehicles} />
